...
public class Main {
  ...
  public static void main(String[] args) {
	...
	//boolean[][] image1 = {{true, true},{true, false}};
	//boolean[][] image2 = {{true, true},{true, false}};
    ...
    //testCompareAllFingerprints("2_2", 2, true);
  ...
  public static void CompareAllTrue(){
  int nbCompare = 0;
  int nbTrue = 0;
    for(int i = 1; i < 17; ++i){
      for(int j = 1; j < 9 ; ++j){
    ...
    System.out.println(nbCompare);
  }

  public static void CompareAllFinger() {
    ...
    for (int i = 1; i < 17; ++i) {
      for (int j = 1; j < 9; ++j) {
        boolean[][] image1 = Helper.readBinary("resources/fingerprints/" + i + "_" + j + ".png");
        ...
        for (int k = i; k < 17; ++k) {
          for (int l = 1; l < 9; ++l) {
            if (k == i) {
              if (l > j) {
                boolean[][] image2 = Helper.readBinary("resources/fingerprints/" + k + "_" + l + ".png");
                boolean[][] skeleton2 = Fingerprint.thin(image2);
                List<int[]> minutiae2 = Fingerprint.extract(skeleton2);
                nbTrue += (Fingerprint.match(minutiae1, minutiae2)) ? nbTrue : 0;
                ++nbComparaison;
              }
            } else {
              boolean[][] image2 = Helper.readBinary("resources/fingerprints/" + k + "_" + l + ".png");
              boolean[][] skeleton2 = Fingerprint.thin(image2);
              List<int[]> minutiae2 = Fingerprint.extract(skeleton2);
              nbTrue += (Fingerprint.match(minutiae1, minutiae2) == (k==i)) ? nbTrue : 0;
              ++nbComparaison;
            }
            System.out.println(nbComparaison);
          }
        }
      }
    }
    System.out.println("Number of image compared : "+nbComparaison);
    System.out.println("Number of image matching : "+nbTrue);
    System.out.println("Percentage : "+(nbTrue/nbComparaison) *100);
  }
  ...
  public static void testDrawSkeleton(String name) {
	    ...
	    boolean[][] skeleton1 = Fingerprint.thin(image1);
	    //Helper.show(skeleton1, name);
	    System.out.println("writeBinary return : " + Helper.writeBinary("resources/test_skeleton_" + name + ".png", skeleton1));
